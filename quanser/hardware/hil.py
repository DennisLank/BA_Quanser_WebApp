...
class HIL:
    ...
    def __init__(self, card_type=None, card_identifier="0"):
        self._card = None
    ...
    INFINITE = 0x7fffffff
    """Value meant to represent infinity for number of smaples in task_start method"""
    ...
    def open(self, card_type, card_identifier="0"):
    ...
    def get_string_property(self, property_code, buffer_size):
        ...
        buffer_size : int
            The maximum size of the string in code units (bytes).
        ...
        """
        _buffer = ffi.new(_CHAR_ARRAY, buffer_size)
        ...
        return ffi.string(_buffer).decode("UTF-8")
    ...
    def read(self,
        ...
        as digital inputs must be configured as inputs using this function. Failure to configure the digital I/O may
        result in hardware conflicts where an output is connected to an output!
